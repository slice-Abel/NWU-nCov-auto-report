...
def sent_report(cookies):
    ...
    params = {
        ...
        "city":"西安市",
        "province":"陕西省",
        "address":"陕西省西安市碑林区太白北路西北大学北校区学生公寓11号楼西北大学太白校区",
        "geo_api_info":'{"type":"complete","info":"SUCCESS","status":1,"$Da":"jsonp_687452_","message":"Get ipLocation success.Get address success.","location_type":"ip","accuracy":null,"isConverted":true,"addressComponent":{"citycode":"029","adcode":"610103","businessAreas":[],"neighborhoodType":"","neighborhood":"","building":"","buildingType":"","street":"太白北路","streetNumber":"229号","country":"中国","province":"陕西省","city":"西安市","district":"碑林区","towncode":"610103008000","township":"张家村街道"},"formattedAddress":"陕西省西安市碑林区张家村街道西北大学太白校区制药工程系","roads":[],"crosses":[],"pois":[]}',   #高德SDK返回值
        "sfcyglq":"0",  #是否隔离期
        "sfyzz":"0",    #是否有症状
        "qtqk":"",  #其他情况
        "ymtys":""  #不明（可能是一码通颜色，暂无用）
